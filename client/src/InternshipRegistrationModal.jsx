      ...
      <motion.div
        ...
        <motion.div
          ...
          <div className="sticky top-0 z-10 rounded-t-2xl sm:rounded-t-3xl overflow-hidden">
            ...
            {/* gold bar */}
            <motion.div className="h-0.75 w-full origin-left" style={{ background: "linear-gradient(90deg,#D4AF37,#E66B26,#D4AF37)" }}
          ...
          <div className="px-5 sm:px-6 pt-5">
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .2, ease: EASE_EXPO }}
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-black text-[#E66B26] truncate">{internship.title}</p>
                {internship.duration && (
                ...
                <StaggerItem>
                  <div className="flex gap-3 mt-5 pb-1">
                    ...
                    <MagBtn type="button" onClick={onClose}
                      className="px-5 py-3 rounded-xl font-black text-sm border border-gray-200 text-[#1A1A1A] hover:border-[#E66B26] hover:text-[#E66B26] transition-all bg-white">
                      Cancel
                    </MagBtn>
                  </div>
                </StaggerItem>
